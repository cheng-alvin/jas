...
### ⚡Quick start
Jas takes instructions in an array in a struct form defined in [instruction.h]https://github.com/cheng-alvin/jas/blob/0faa905be7cb1238796af46552b3271a11b4e2dd/libjas/instruction.h#L110-L113) 
```c
#include <jas.h>
