...
jasErrorCode_t add(jasTaggedOperand_t op1, jasTaggedOperand_t op2, jasTaggedOperand_t op3, jasTaggedOperand_t op4, jasInstance_t *instance) {
  ...
  case JAS_REG_OPERAND_8:
    ...
    WRITE_IF_BREAKS(op1.operand.reg.reg8 == JAS_REG_AL, 0x04)

    WRITE_IF_BREAKS(op1.type == JAS_REG_OPERAND_8 && (op2.type == JAS_REG_OPERAND_8 || op2.type == JAS_INDIRECT_8), 0x02)
    WRITE_IF_BREAKS(op2.type == JAS_REG_OPERAND_8, 0x00)
  ...
  case JAS_REG_OPERAND_16:
    ...
    WRITE(0x66)
    WRITE_IF_BREAKS(op1.type == JAS_REG_OPERAND_16 && (op2.type == JAS_REG_OPERAND_16 || op2.type == JAS_INDIRECT_16), 0x03)
    WRITE_IF_BREAKS(op1.operand.reg.reg16 == JAS_REG_AX, 0x05)
    WRITE_IF_BREAKS(op2.type == JAS_OPERAND_8, 0x83)
    WRITE_IF_BREAKS(op2.type == JAS_REG_OPERAND_16, 0x01)
  ...
  case JAS_REG_OPERAND_32:
    ...
    WRITE_IF_BREAKS(op1.type == JAS_REG_OPERAND_32 && (op2.type == JAS_REG_OPERAND_32 || op2.type == JAS_INDIRECT_32), 0x03)
    WRITE_IF_BREAKS(op1.operand.reg.reg32 == JAS_REG_EAX, 0x05)
    WRITE_IF_BREAKS(op2.type == JAS_OPERAND_8, 0x83)
    WRITE_IF_BREAKS(op2.type == JAS_REG_OPERAND_32, 0x01)
  ...
  case JAS_REG_OPERAND_64:
    ...
    WRITE_IF_BREAKS(op1.type == JAS_REG_OPERAND_64 && (op2.type == JAS_REG_OPERAND_64 || op2.type == JAS_INDIRECT_64), 0x03)
    WRITE_IF_BREAKS(op1.operand.reg.reg64 == JAS_REG_RAX, 0x05)
    WRITE_IF_BREAKS(op2.type == JAS_OPERAND_8, 0x83)
    WRITE_IF_BREAKS(op2.type == JAS_REG_OPERAND_64, 0x01)
