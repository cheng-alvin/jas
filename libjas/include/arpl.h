 ...
 * @since v0.0.1
 *
 * Function for Generating the code for the `arpl` instruction, normally
 ...
 * manual for more information on the `arpl` instruction.
 * @note Only 16-bit operands are allowed. (i.e `r/m16` or `r16`)
 *
 * @warning This is NOT an assembly tutorial. Please see other resources for
 * more information on the `arpl` instruction. We expect that you know assembly and
