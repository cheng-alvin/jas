...
/**
 * Function for Generating the code for the `call` instruction, normally
 ...
 *
 * @note All parameters excluding the first operand are not required.
 * Please see the intel manual for more information on the `call` instruction.
 *
 * ! TODO Problematic instruction, please revise
 */
