...
/**
 * Function for Generating the code for the `cld` instruction, normally
 ...
 * information on the `cld` instruction.
 *
...
jasErrorCode_t jasCLD(jasTaggedOperand_t op1, jasTaggedOperand_t op2, jasTaggedOperand_t op3, jasTaggedOperand_t op4, jasInstance_t *instance);
