 ...
 * @since v0.0.1
 *
 * Function for Generating the code for the `bound` instruction, normally
 ...
 * manual for more information on the `bound` instruction.
 *
 * @warning This is NOT an assembly tutorial. Please see other resources for
 * more information on the `bound` instruction. We expect that you know assembly and
