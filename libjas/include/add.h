 ...
 * @since v0.0.1
 *
 * Function for Generating the code for the `add` instruction, normally
 ...
 * manual for more information on the `add` instruction.
 *
 * @warning This is NOT an assembly tutorial. Please see other resources for
 * more information on the `add` instruction. We expect that you know assembly and
