...
/**
 * Function for Generating the code for the `cbw` instruction, normally
 ...
 * information on the `cbw` instruction.
 *
...
jasErrorCode_t jasCBW(jasTaggedOperand_t op1, jasTaggedOperand_t op2, jasTaggedOperand_t op3, jasTaggedOperand_t op4, jasInstance_t *instance);
