...
/**
 * Function for Generating the code for the `btc` instruction, normally
 ...
 * the intel manual for more information on the `btc` instruction.
 *
 * @warning This is NOT an assembly tutorial. Please see other resources for
 * more information on the `btc` instruction. We expect that you know assembly and
