...
/**
 * Function for Generating the code for the `btr` instruction, normally
 ...
 * the intel manual for more information on the `btr` instruction.
 *
 * @warning This is NOT an assembly tutorial. Please see other resources for
 * more information on the `btr` instruction. We expect that you know assembly and
